...
INSERT INTO PAYMENT
VALUES(0, 111, 'user', '레시피', '1393, 1211', '3000', 1, 1, '2999-12-12 09시 12분', '배송');
...
SELECT R.RECIPE_NAME, P.PAYMENT_DATE, M.MATERIAL_NAME FROM RECIPE R, PAYMENT P, MATERIAL M WHERE P.ID = 'user'